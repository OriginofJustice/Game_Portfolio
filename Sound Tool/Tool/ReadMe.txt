...
ToolDoc.h, ToolDoc.cpp ? 문서
    ...
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:      JST
        파일 형식 ID:        SoundTool.Document
        주 프레임 캡션:  Sound Tool
        문서 형식 이름:       SoundTool
        필터 이름:         Sound Tool Files (*.JST)
        파일의 새 약식 이름: SoundTool
        파일 형식의 긴 이름: SoundTool.Document

ToolView.h, ToolView.cpp ? 문서 뷰
    이 파일에는 CToolView 클래스가 들어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Tool.pch와
